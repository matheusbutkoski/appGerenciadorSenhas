import 'package:gerenciadorsenhas/Data/Perfil/perfil_entity.dart';
  ...
  Future<List<PerfilEntity>> getAllPerfil() async {
   ...
   Future<bool> getPerfilLogin(login, senha) async {
    ...
    List<Map> dbResult = await db.rawQuery(
        'SELECT * from $PERFIL_TABLE_NAME where $PERFIL_COLUMN_EMAIL = ? and $PERFIL_COLUMN_SENHA = ?',[login,senha]);
